...
cbs_file =fullfile(dirname,"example/SiO2_5um_bead_CBS_two_beam.mat");
if isfile(cbs_file)
...
fdtd_file =fullfile(dirname,"example/SiO2_5um_bead_FDTD_two_beam.mat");
if isfile(fdtd_file)
...
legend('CBS', 'FDTD'), title('Axial intensity')
